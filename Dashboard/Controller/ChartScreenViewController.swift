...
//  ChartDemo
//
//  Created by Xanthus Software Solutions on 28/07/20.
...
class ChartScreenViewController: UIViewController {
    
    @IBOutlet weak var changeGraphType: UIButton!
    ...
    @IBAction func changeGrapohType(_ sender: UIButton) {
...
extension ChartScreenViewController: UITableViewDataSource, UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        return self.graphTableView.frame.height
    }
    
//    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
//        performSegue(withIdentifier: "GraphToDetail", sender: self)
//    }
